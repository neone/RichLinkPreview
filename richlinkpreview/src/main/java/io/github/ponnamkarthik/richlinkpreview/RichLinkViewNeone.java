...
public class RichLinkViewNeone extends RelativeLayout {
    ...
    public RichLinkViewNeone(Context context) {
        super(context);
        this.context = context;
    }

    public RichLinkViewNeone(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public RichLinkViewNeone(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public RichLinkViewNeone(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void initView() {
        if(findLinearLayoutChild() != null) {
            ...
            this.view = this;
            inflate(context, R.layout.neone_link_layout,this);
        }

        constraintLayout = (ConstraintLayout) findViewById(R.id.rich_link_card);
